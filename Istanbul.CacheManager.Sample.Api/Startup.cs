...
using Istanbul.CacheManager.Extensions;
using Istanbul.CacheManager.Provider.Memory;
using Istanbul.CacheManager.Provider.Redis;
...
namespace Istanbul.CacheManager.Sample.Api
{
